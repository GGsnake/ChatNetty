...
public class RabbitMqConfig {
    ...
    @Bean
    public DirectExchange logUserEx() {
        return new DirectExchange(env.getProperty("log.user.exchange.name"), true, false);
    }

    @Bean
    public Binding logUserBing() {
        return BindingBuilder.bind(logUserQueue()).to(logUserEx()).with(env.getProperty("log.user.routing.key.name"));
